...
declare var IAjax: AjaxModule.IAjaxStatic;
declare module "AjaxModule" {
    export = AjaxModule;
}
declare module AjaxModule {
    interface IAjaxStatic {
        Request: AjaxModule.Request<any>;
        Response: AjaxModule.Response;
    ...
    interface Request<Req extends Request<any>> /* extends NodeJS.WritableStream */ {
      ...
      part(): Req;
      pipe(stream: NodeJS.WritableStream, options?: Object): any;
